...
const SupplierLayout = () => {
  ...
  return (
    <div className="flex flex-col h-screen bg-gray-100">
      {/* Top Navbar - similar to buyer interface */}
        ...
        <div className="flex items-center justify-between p-4">
          ...
          <div className="hidden md:flex flex-1 mx-10">
            <div className="relative w-full max-w-xl">
              ...
              <input
                type="text"
                placeholder="Search orders, products, RFQs..."
                className="pl-10 pr-4 py-2 border rounded-md w-full focus:outline-none focus:ring-2 focus:ring-toreso-teal focus:border-transparent"
              />
            </div>
          </div>
      ...
      <div className="flex flex-1 overflow-hidden">
        {/* Sidebar - Desktop */}
        <aside
          className={`bg-white border-r border-gray-200 h-full transition-all duration-300 hidden md:block ${
            collapsed ? "w-20" : "w-64"
          }`}
        >
